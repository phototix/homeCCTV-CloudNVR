...
ffmpeg.exe ^
-rtsp_transport udp ^
-i "rtsp://%RTSP_USER%:%RTSP_PASS%@192.168.1.124:554/stream2" ^
-i "rtsp://%RTSP_USER%:%RTSP_PASS%@192.168.1.126:554/stream2" ^
-i "rtsp://%RTSP_USER%:%RTSP_PASS%@192.168.1.128:554/stream2" ^
-i blank.png ^
